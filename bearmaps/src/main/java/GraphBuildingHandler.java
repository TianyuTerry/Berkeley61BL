...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private GraphDB.Road currentRoad;
    private ArrayList<Long> vertexOnRoad;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            currentVertex = new GraphDB.Vertex(id, lon, lat);
            g.allNodes.put(id, currentVertex);
            g.neighbors.put(id, new HashSet<>());

        } else if (qName.equals("way")) {
            /* Encountering a new <way...> tag. */
            activeState = "way";
            // System.out.println("Beginning a way...");
            currentRoad = new GraphDB.Road();
            vertexOnRoad = new ArrayList<>();
            ...
            String k = attributes.getValue("k");
            String v = attributes.getValue("v");
            currentVertex.putInformation(k, v);
        }
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            currentRoad.passBy = vertexOnRoad;
            g.roads.add(currentRoad);
        }
    }
